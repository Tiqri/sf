...
using Blissmo.NotificationService.Interface;
using Blissmo.NotificationService.MessageBrokerProvider;
using Microsoft.ServiceFabric.Services.Communication.Runtime;
using Microsoft.ServiceFabric.Services.Runtime;

namespace Blissmo.NotificationService
{
    /// <summary>
    ...
    internal sealed class NotificationService : StatelessService, INotificationService
    {
        ...
        {
            await this._bookingMessageBroker.ReceiveMessageAsync();
        }
    }
}
